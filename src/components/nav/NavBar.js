        ...
        <nav className="navbar bg-light text-black flex-md-nowrap p-0 shadow">
            ...
            <ul className="nav nav-pills nav-fill">
                <li className="nav-item">
                    ...
                    <a>
                        <img href="https://interlincmortgage.com/mt-juliet" src="https://interlincmortgage.com/images/logo.png?ver=2" width="180" alt="Interlinc Mortgage"></img>
                    </a>
                </li>
                <li className="nav-item">
                ...
                <li className="nav-item">
                    <Link className="nav-link" to="/Calculators">Property Taxes</Link>
                </li>
                <li className="nav-item">
